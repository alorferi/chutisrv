                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="/admin/calendar">Calendar</a>
                                <a class="dropdown-item" href="/admin/daydate">DayDate</a>
                                <a class="dropdown-item" href="/admin/day">Day</a>
                                <a class="dropdown-item" href="/admin/holidaytype">Holiday Type</a>
                                <a class="dropdown-item" href="/admin/dayflag">Day Flag</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <a class="dropdown-item" href="/admin/match">Match</a>
                                <a class="dropdown-item" href="/admin/team">Team</a>

                                <a class="dropdown-item" href="/admin/stadium">Stadium</a>
