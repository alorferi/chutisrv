...
{{ Form::model($dayDate, array('route' => array('daydate.confirm.trash', $dayDate->id), 'method' => 'DELETE')) }}
...
{{ Form::submit('Confirm to trash this Item?', array('class' => 'btn btn-small btn-warning')) }}
