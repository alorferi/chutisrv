...
{{ Form::model($dayDate, array('route' => array('daydate.destroy', $dayDate->id), 'method' => 'DELETE')) }}
...
{{ Form::submit('Confirm to delete this Item?', array('class' => 'btn btn-small btn-danger')) }}
